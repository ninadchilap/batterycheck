...
public class DetectPowerDisconnectedService extends Service {
...

		{
			...
			if (plugged == 0) {
				...
				if (count_id != 0) {
					...
					String timeTaken = getTimeDiff(prevTime, curTime); // get
																		// time
																		// diff
																		// of
																		// start
	 ...
	 * "AC power is disconnected"); bundle.putString("message_text",
	 ...
	 * notificationManager.notify(2, // Unique ID of notification notification);
	 * // Notification } }, 500); }
	 */
	// Show toast notification
	/*
	 ...
	 * "AC power is disconnected"); message.obj = bundle;
	 * toastHandler.sendMessage(message); } }, 5000);
	 * 
	 * }
	 */
